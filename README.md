...
отмечаются жёлтым цветом (разовая акция: при повторном запуске жёлтый обратно превратится 
в бесцветный). Проверенные помечаются зелёным (и надписи в тексте меняются).
...
TODO: жёлтая перестаёт быть жёлтой через два дня (при условии, что не менялась) становится 
бесцветной, если зелёная уже держится неделю, то удалить.